...
for cfg_file in [ "quickmarks", "bookmarks/urls", 
        ...
        if not os.path.exists("/home/andrey/.config/qutebrowser/"+cfg_file):
            ...
            shutil.copyfile("/etc/my_cfg/net/qutebrowser/"+cfg_file, "/home/andrey/.config/qutebrowser/"+cfg_file)
...
d_open_url={
'set-cmd-text -s :open -w' : ['o','щ'],
'set-cmd-text -s :open -t' : ['O','Щ'],
'set-cmd-text -s :open -p' : ['wp','цз'],
'set-cmd-text -s :open -b' : ['wb','ци'],
'set-cmd-text -s :open -w {url}' : ['wu','цг'],
'set-cmd-text -s :open -t {url}' : ['wU','цГ'],
'open -w {clipboard}' : ['pp','зз'],
'open -w {primary}' : ['pP','зЗ'],
'open -t {clipboard}' : ['Pp','Зз'],
'open -t {primary}' : ['PP','ЗЗ'],
}
...
d_bookmarks={
'home' : ['~'],
'set-cmd-text -s :quickmark-load -w' : ['b','и'],
'set-cmd-text -s :quickmark-load -t' : ['B','И'],
'set-cmd-text -s :bookmark-load -w' : ['gb','пи'],
